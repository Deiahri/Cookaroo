  ...
  '68f45-c6ae9a0-800565-8d3a84c-7c0b371': {
    ...
    ingredients: [
      ...
      },
      {
        ...
        ingredients: [
          ...
          { name: "Lactose-free parmesan cheese", quantity: "1/2 cup, grated", price: 1.2 },
      ...
      },
      {
        name: "Chicken",
        ingredients: [
          { name: "Chicken breast", quantity: "2 (about 1 lb), sliced", price: 4.0 },
    ...
    instructions: [
      ...
      },
      {
        name: "Serving",
        steps: [
          { text: "Serve hot, garnished with chopped fresh parsley." }
        ]
      }
    ]
  },
    ...
    ingredients: [
      {
        name: "Chicken",
        ingredients: [
          { name: "Boneless skinless chicken thighs", quantity: "1 lb", price: 3.5 },
